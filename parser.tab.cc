...
#line 144 "parser.tab.cc"
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_exp_const: // exp_const
        value.copy< std::variant<BigInt, BigFraction, std::string> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_CONSTANT: // CONSTANT
      case symbol_kind::S_exp_const: // exp_const
        value.move< std::variant<BigInt, BigFraction, std::string> > (YY_MOVE (s.value));
        break;
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_CONSTANT: // CONSTANT
      case symbol_kind::S_exp_const: // exp_const
        value.YY_MOVE_OR_COPY< std::variant<BigInt, BigFraction, std::string> > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_CONSTANT: // CONSTANT
      case symbol_kind::S_exp_const: // exp_const
        value.move< std::variant<BigInt, BigFraction, std::string> > (YY_MOVE (that.value));
        break;
  ...
  parser::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_CONSTANT: // CONSTANT
      case symbol_kind::S_exp_const: // exp_const
        value.copy< std::variant<BigInt, BigFraction, std::string> > (that.value);
        break;
  ...
  parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_CONSTANT: // CONSTANT
      case symbol_kind::S_exp_const: // exp_const
        value.move< std::variant<BigInt, BigFraction, std::string> > (that.value);
        break;
...
else if (holds_alternative<std::string>(yysym.value.template as < std::variant<BigInt, BigFraction, std::string> > ())) {
	std::cout << get<std::string>(yysym.value.template as < std::variant<BigInt, BigFraction, std::string> > ());
}
else if (holds_alternative<BigFraction>(yysym.value.template as < std::variant<BigInt, BigFraction, std::string> > ())) {
	std::cout << get<BigFraction>(yysym.value.template as < std::variant<BigInt, BigFraction, std::string> > ());
}
}
#line 455 "parser.tab.cc"
  ...
  yyreduce:
      ...
      switch (yyr1_[yyn])
    {
      ...
      case symbol_kind::S_CONSTANT: // CONSTANT
      case symbol_kind::S_exp_const: // exp_const
        yylhs.value.emplace< std::variant<BigInt, BigFraction, std::string> > ();
        break;
