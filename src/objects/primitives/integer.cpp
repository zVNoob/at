...
std::shared_ptr<Object> on_less(arg_list args) {
  return std::make_shared<Integer>(
        BigInt(static_cast<Integer*>(args[0].get())->value < 
               static_cast<Integer*>(args[1].get())->value));
}
...
std::shared_ptr<Object> on_greater(arg_list args) {
  return std::make_shared<Integer>(
        BigInt(static_cast<Integer*>(args[0].get())->value > 
               static_cast<Integer*>(args[1].get())->value));
}

std::shared_ptr<Object> on_or(arg_list args) {
  return std::make_shared<Integer>(
        static_cast<Integer*>(args[0].get())->value |
        static_cast<Integer*>(args[1].get())->value
  );
...
std::shared_ptr<Object> on_and(arg_list args) {
  return std::make_shared<Integer>(
        static_cast<Integer*>(args[0].get())->value &
        static_cast<Integer*>(args[1].get())->value
  );
...
std::shared_ptr<Object> on_xor(arg_list args) {
  return std::make_shared<Integer>(
        static_cast<Integer*>(args[0].get())->value ^
        static_cast<Integer*>(args[1].get())->value
  );
...
std::shared_ptr<Object> on_not(arg_list args) {
  return std::make_shared<Integer>(
      -static_cast<Integer*>(args[0].get())->value+BigInt(1)
  );
}
...
std::shared_ptr<type::Type> Get_Integer_type() {
  ...
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
    func_obj->push_func(std::make_shared<InternalFunction>(on_or),{Get_Integer_type(),Get_Integer_type()});
    type->members["|"] = func_obj;
  }
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
    func_obj->push_func(std::make_shared<InternalFunction>(on_and),{Get_Integer_type(),Get_Integer_type()});
    type->members["&"] = func_obj;
  }
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
    func_obj->push_func(std::make_shared<InternalFunction>(on_xor),{Get_Integer_type(),Get_Integer_type()});
    type->members["^"] = func_obj;
  }
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
    func_obj->push_func(std::make_shared<InternalFunction>(on_not),{Get_Integer_type()});
    type->members["!"] = func_obj;
  }
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
    func_obj->push_func(std::make_shared<InternalFunction>(on_less),{Get_Integer_type(),Get_Integer_type()});
    type->members["<"] = func_obj;
  }
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
    func_obj->push_func(std::make_shared<InternalFunction>(on_equal),{Get_Integer_type(),Get_Integer_type()});
    type->members["=="] = func_obj;
  }
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
    func_obj->push_func(std::make_shared<InternalFunction>(on_greater),{Get_Integer_type(),Get_Integer_type()});
    type->members[">"] = func_obj;
  }
  {
    auto func_obj = std::make_shared<TypedFunction>(Get_Integer_type());
