...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // vars
      // expr
      char dummy2[sizeof (std::shared_ptr<object::Object>)];

      // type
      char dummy3[sizeof (std::shared_ptr<type::Type>)];

      // arg_list
      // expr_list
      // var_list
      char dummy4[sizeof (std::vector<std::shared_ptr<object::Object>>)];

      // type_list
      char dummy5[sizeof (std::vector<std::shared_ptr<type::Type>>)];
    };
    ...
    UNRESOLVED_VARIABLE = 264,     // UNRESOLVED_VARIABLE
    TYPE = 265,                    // TYPE
    TYPE_PREC = 266,               // TYPE_PREC
    UNARY = 267                    // UNARY
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_UNRESOLVED_VARIABLE = 9,               // UNRESOLVED_VARIABLE
        S_TYPE = 10,                             // TYPE
        S_11_ = 11,                              // ':'
        S_12_ = 12,                              // '='
        S_TYPE_PREC = 13,                        // TYPE_PREC
        S_14_ = 14,                              // '?'
        S_15_ = 15,                              // '['
        S_16_ = 16,                              // ']'
        S_17_ = 17,                              // '('
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<object::Object>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::EQUAL)
                   || tok == 58
                   || tok == 61
                   || tok == token::TYPE_PREC
                   || tok == 63
...
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, std::shared_ptr<object::Object> v, location_type l)
        : super_type (token_kind_type (tok), std::move (v), std::move (l))
#else
      symbol_type (int tok, const std::shared_ptr<object::Object>& v, const location_type& l)
    ...
    Parser (lexer::Lexer* lexer_yyarg, error::ErrorReporter* err_rp_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INTEGER (const std::shared_ptr<object::Object>& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_FRACTION (std::shared_ptr<object::Object> v, location_type l)
      {
        return symbol_type (token::FRACTION, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_FRACTION (const std::shared_ptr<object::Object>& v, const location_type& l)
      {
        return symbol_type (token::FRACTION, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_STRING (std::shared_ptr<object::Object> v, location_type l)
      {
      ...
      static
      symbol_type
      make_STRING (const std::shared_ptr<object::Object>& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_UNRESOLVED_VARIABLE (std::shared_ptr<object::Object> v, location_type l)
      {
        return symbol_type (token::UNRESOLVED_VARIABLE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_UNRESOLVED_VARIABLE (const std::shared_ptr<object::Object>& v, const location_type& l)
      {
        return symbol_type (token::UNRESOLVED_VARIABLE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
